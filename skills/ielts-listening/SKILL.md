...
```bash
python3 ~/.claude/skills/shared/ielts_cli.py listening add --test-name "<name>" --total-questions 40 --correct <n> --score <band> --section-scores '<json>' --question-type-errors '<json>' --key-errors '<json>'
```
